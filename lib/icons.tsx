// Shared SVG icon components for the Belvedere AI application
// All icons are 18x18 by default, stroke-based, professional look
...
export const IconBelvedereLogo = ({ size = 24, className }: { size?: number; className?: string }) => (
  <span 
    className={className} 
    style={{ 
      fontSize: size, 
